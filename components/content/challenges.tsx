...
const Challenges = (): JSX.Element => {
  return (
    <>
      <section className="py-8 flex flex-auto justify-end text-right -translate-x-4 text-white font-extrabold text-4xl md:text-2xl sm:text-xl hover:italic hover:transition-transform  hover:-translate-x-8">
